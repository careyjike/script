...
Install_MariaDB55() {
  ...
  if [ "${install_mod}" == "binary" ]; then
    src_url=https://mirrors.tuna.tsinghua.edu.cn/mariadb/mariadb-${mariadb55_version}/bintar-${GLIBC_FLAG}-${SYS_BIT_a}/mariadb-${mariadb55_version}-${GLIBC_FLAG}-${SYS_BIT_b}.tar.gz && wget -c --tries=6 --no-check-certificate $src_url
    # src_url=https://downloads.mariadb.org/interstitial/mariadb-${mariadb55_version}/bintar-${GLIBC_FLAG}-${SYS_BIT_a}/mariadb-${mariadb55_version}-${GLIBC_FLAG}-${SYS_BIT_b}.tar.gz && wget -c --tries=6 --no-check-certificate $src_url
    ...
    src_url=https://mirrors.tuna.tsinghua.edu.cn/mariadb/mariadb-${mariadb55_version}/source/mariadb-${mariadb55_version}.tar.gz && wget -c --tries=6 --no-check-certificate $src_url
    # src_url=https://downloads.mariadb.org/interstitial/mariadb-${mariadb55_version}/source/mariadb-${mariadb55_version}.tar.gz && wget -c --tries=6 --no-check-certificate $src_url
